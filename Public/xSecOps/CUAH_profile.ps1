...
# Creates drive shortcut for Repos, if current user account is using it
if (Test-Path "D:\Repos")
{
    New-PSDrive -Name Repos -PSProvider FileSystem -Root "D:\Repos" -Description "Repos"
